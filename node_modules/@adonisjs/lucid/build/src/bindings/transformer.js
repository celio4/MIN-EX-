 ...
 */
export function defineTransformerBindings(Transformer) {
    Transformer.prototype.withCount = function (relationship) {
        ...
        if (aggregateValue === undefined) {
            throw new Error(`Cannot transform undefined value. Use "this.whenCounted(relationship)" to allow undefined values`);
        }
    ...
    Transformer.prototype.withAggregate = function (alias) {
        const aggregateValue = this.resource.$extras?.[alias];
        if (aggregateValue === undefined) {
            throw new Error(`Cannot transform undefined value. Use "this.whenAggregated(alias)" to allow undefined values`);
        }
        return Number(aggregateValue);
    };
