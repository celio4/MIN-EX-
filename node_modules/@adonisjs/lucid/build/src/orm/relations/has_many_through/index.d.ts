...
export declare class HasManyThrough implements HasManyThroughRelationContract<LucidModel, LucidModel> {
     ...
     */
    eagerQuery(parent: OneOrMany<LucidRow>, client: QueryClientContract): import("./query_builder.ts").HasManyThroughQueryBuilder;
    /**
     * Returns instance of query builder
     */
    subQuery(client: QueryClientContract): import("./sub_query_builder.ts").HasManyThroughSubQueryBuilder;
}
