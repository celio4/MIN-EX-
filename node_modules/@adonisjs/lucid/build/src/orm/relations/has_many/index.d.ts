...
export declare class HasMany implements HasManyRelationContract<LucidModel, LucidModel> {
     ...
     */
    eagerQuery(parent: OneOrMany<LucidRow>, client: QueryClientContract): import("./query_builder.ts").HasManyQueryBuilder;
    /**
     * Returns instance of query builder
     */
    subQuery(client: QueryClientContract): import("./sub_query_builder.ts").HasManySubQueryBuilder;
    /**
