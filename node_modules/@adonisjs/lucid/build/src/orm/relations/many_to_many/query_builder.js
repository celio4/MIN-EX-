...
export class ManyToManyQueryBuilder extends BaseQueryBuilder {
    ...
    getGroupLimitQuery() {
        ...
        this.select(this.client.raw(`row_number() over (PARTITION BY ?? ORDER BY ?? ${direction}) as ${rowName}`, [this.pivotHelpers.prefixPivotTable(this.relation.pivotForeignKey), column])).as('adonis_temp');
